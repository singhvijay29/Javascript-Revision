var cont = document.getElementById("cont-div"); 

let limit =100;
let pageCount = 1;
let postCount = 1;

fetch(`https://pixabay.com/api/?key=25504524-28efba40bd9bf8a3773d8ce37&category=nature&per_page=${limit}&page=${pageCount}`)
// https://pixabay.com/?key=api/25504524-28efba40bd9bf8a3773d8ce37&image_type=photo&pretty=true
.then(res => res.json())
.then(data => getdata(data.hits))
.catch(err => console.log(err));


function getdata(photos ){
var curr = document.getElementById("cont-div"); 
    {photos.forEach(photo =>{
console.log(photo)
curr.innerHTML += `
<div class="cont-div-boxes">
